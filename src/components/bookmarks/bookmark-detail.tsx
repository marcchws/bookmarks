  ...
  return (
    <>
      ...
      >
        ...
        {/* Action bar footer — REQ-a11y-5, REQ-resp-3 */}
        <footer className="flex flex-wrap items-center gap-2 border-t border-outline bg-surface-container px-4 py-3">
          {/* Destructive on left per DESIGN.md reference */}
          <button
            type="button"
            onClick={() => setDeleteOpen(true)}
            className={cn(
              "relative inline-flex items-center gap-1.5 border border-error px-3 py-2",
